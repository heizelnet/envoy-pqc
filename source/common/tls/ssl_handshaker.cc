...
Network::PostIoAction SslHandshakerImpl::doHandshake() {
  ...
  if (rc == 1) {
    ...
    ENVOY_LOG_MISC(info, "[+]SSL error detail: {}, error_string: {}", err, ERR_error_string(error, nullptr));
    ...
    case SSL_ERROR_WANT_READ:
      ENVOY_LOG_MISC(info, "[+]Network::PostIoAction - {}", "SslHandshakerImpl::doHandshake - SSL_ERROR_WANT_READ");
    case SSL_ERROR_WANT_WRITE:
      ENVOY_LOG_MISC(info, "[+]Network::PostIoAction - {}", "SslHandshakerImpl::doHandshake - SSL_ERROR_WANT_WRITE");
